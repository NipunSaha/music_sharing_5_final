...
def musicWindow():
    ...
    listbox = Listbox(window,height=10,width=39,activestyle="dotbox",bg="cyan",borderwidth=2, font=("Calibri",10))
    ...
    Download = Button(window,text="Download",width=10,bd=1,bg="Blue",font=("Calibri",10),command=download)
